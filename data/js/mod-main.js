// Grab the specific location within the HTML on the techsupport.csun.edu/ozSptMain.jsp page to insert the "Quick Case" button
$('body > table:eq(3) > tbody:eq(0) > tr:eq(0) > td:eq(2)').prepend('<div id="buttonBar"></div>');
